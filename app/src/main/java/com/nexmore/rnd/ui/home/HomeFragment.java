    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        root.findViewById(R.id.cardView).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_nav_home_to_nav_location);
            }
        });
        ...
        root.findViewById(R.id.cardView2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_nav_home_to_fireMapFragment);
            }
        });
